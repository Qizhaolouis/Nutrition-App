...
public class UserHandler  implements Route{
	...
	private final String userForm = "<form action=\"/addProfile\" method=\"post\">Add User Profile:"
			...
			+ "<br><br>"
			+ "<label for=\\\"userSleep\\\">How long to you sleep? (We only has M and F now)</label>"
			+ "<br><br>"
			+ "<input id=\"sleepInput\" type=\"range\" name=\"userSleep\" , min=\"0\" max=\"24\"value=\"8\"\n"
			+ "oninput=\"sleepTime.value=sleepInput.value\">"
